...
function SetFilter(category, name) {
  ...
  if (category == "type") {
    ...
    document.getElementById("nav_filter_typebtn").innerHTML =
  ...
  if (category == "rarity") {
    ...
    document.getElementById("nav_filter_raritybtn").innerHTML =
      name + ' <span class="caret"></span>';
  }
  loadedPlanets = 0;
  if (Filterpage == "all") {
...
function SetFilterHtml() {
  ...
  navBonus.forEach((el) => {
    document.getElementById("nav_filter_rarity").innerHTML +=
      "<li><a href=\"#\" onclick=\"SetFilter('rarity','" +
      el +
      "')\">" +
      el +
      "</a></li>";
  ...
  navTypes.forEach((el) => {
    document.getElementById("nav_filter_type").innerHTML +=
      "<li><a href=\"#\" onclick=\"SetFilter('type','" +
      el +
      "')\">" +
      el +
      "</a></li>";

...
var infp =
  'Enter the username in the form field and then click on "Gift now" to gift a planet.<br><div style="margin:12px 0 12px 0;">Fee for planet transfer: <b>1000 Stardust</b></div>';
var prc =
  '<div style="color:#a94442;margin:0 0 12px 0;"><i>Warning: This transaction is irreversible. All ships on the planet will be transmitted.</i></div>';
var oout =
  '<div style="color:#a94442;margin:0 0 12px 0;"><i>Oops! You can not gift planets with outgoing missions.</i></div>';
var nesd =
  '<div style="color:#a94442;margin:0 0 10px 0;"><i>Not enough Stardust in your <a href="wallet.php" style="color:#333;" target="blank" class="steem-keychain-checked">wallet</a>.</i></div>';

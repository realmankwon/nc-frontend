      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a class="headerfix-fa tooltips_top" href="production.php" id="qyt_coal">0 C</a></li>
            <li><a class="headerfix-a tooltips_top" href="production.php" id="qyt_ore">0 Fe</a></li>
            <li><a class="headerfix-a tooltips_top" href="production.php" id="qyt_copper">0 Cu</a></li>
            <li><a class="headerfix-a tooltips_top" href="production.php" id="qyt_uranium">0 U</a></li>
            <li><a href="wallet.php" id="qyt_stardust" class="tooltips_top" style="color:#72bcd4;">0 SD<span style="text-shadow:none;"><b>Stardust</b><br>Earn In-game tokens while playing</span></a></li>
            ...
            <li class="dropdown" id="loginsuccess-nav">
                ...
                <li><a href="buffs.php">Buffs</a></li>
